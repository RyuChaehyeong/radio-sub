...
<div class="header2">
        <nav class="header-nav">
            ...
            &nbsp; <a href="/member/findid" style="text-decoration: none; color:white; align-items: center; display: flex;">아이디찾기(임시임시얍!)</a>
            &nbsp; <a href="/member/findpw" style="text-decoration: none; color:white; align-items: center; display: flex;">비밀번호 찾기(임시임시얍!)</a>
